...
import { ArrowLeft, X, CircleUserRound, Check } from "lucide-react";
    ...
    <div className="w-full px4">
      ...
      <div className="w-full flex items-center justify-between py-3">
        ...
        <div className="flex items-center gap-8">
          <div className="text- font-bold flex h-max items-center gap-2">
        ...
        <div className="bg-gray-200 w-40 h-8 flex justify-center items-center rounded-full">
          <p>Model: Opon 1.0</p>
        </div>
        {/* Right side - Actions */}
        <div className="flex items-center gap-3 ">
          ...
          <div className="flex1 w-max  flex items-center gap-0.5 xl:gap-2  justify-end">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                className="w-80 p-0 mr-4 dark:bg-black bgwhite"
                align="end"
              >
                {/* User Info Section */}
