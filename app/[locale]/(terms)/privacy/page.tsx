  ...
  return (
    <div className="flex-1">
        ...
        <div className="p space-y-8 text-gray-700">
          ...
          <section>
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Interpretation and Definitions</h3>
            
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Interpretation</h4>
            ...
            <div>
              <h4 className="text-xl font-medium text-gray-800 mb-3">Definitions</h4>
              <p className="mb-4 font-medium">For the purposes of this Privacy Policy:</p>
              
              <ul className="space-y-4 ml-4">
                <li className="leading-relaxed">
                  <span className="font-semibold">Account</span> means a unique account created for You to access our Service or parts of our Service.
                </li>
                <li className="leading-relaxed">
                  <span className="font-semibold">Company</span> (referred to as either &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SUPERFAN NG.
                </li>
                <li className="leading-relaxed">
                  <span className="font-semibold">Cookies</span> are small files that are placed on Your computer, mobile device or any other
                  device by a website, containing the details of Your browsing history on that website among
                  its many uses.
                </li>
                <li className="leading-relaxed">
                  <span className="font-semibold">Device</span> means any device that can access the Service such as a computer, a cellphone or a
                  digital tablet.
                </li>
                <li className="leading-relaxed">
                ...
                <li className="leading-relaxed">
                  <span className="font-semibold">Service Provider</span> means any natural or legal person who processes the data on behalf of
                ...
                <li className="leading-relaxed">
                  <span className="font-semibold">Usage Data</span> refers to data collected automatically, either generated by the use of the
                  Service or from the service infrastructure itself (for example, the duration of a page visit).
                </li>
                <li className="leading-relaxed">
                  <span className="font-semibold">Website</span> refers to Superfan NG, accessible from https://superfan.ng
                </li>
                <li className="leading-relaxed">
                  <span className="font-semibold">You</span> means the individual accessing or using the Service, or the company, or other legal
          ...
          <section>
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Collecting and Using Your Personal Data</h3>
            
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Types of Data Collected</h4>
              
              <div className="mb-6">
                <h5 className="text-lg font-medium text-gray-800 mb-2">Personal Data</h5>
              ...
              <div className="mb-6">
                <h5 className="text-lg font-medium text-gray-800 mb-2">Usage Data</h5>
                <p className="mb-4 leading-relaxed">
            ...
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Tracking Technologies and Cookies</h4>
              <p className="mb-4 leading-relaxed">
              ...
              <ul className="list-disc ml-6 space-y-3 mb-4">
                <li className="leading-relaxed">
                  <span className="font-medium">Cookies or Browser Cookies.</span> A cookie is a small file placed on Your Device. You can
                ...
                <li className="leading-relaxed">
                  <span className="font-medium">Web Beacons.</span> Certain sections of our Service and our emails may contain small electronic
              ...
              <p className="mb-4 font-medium">We use both Session and Persistent Cookies for the purposes set out below:</p>
              
              <div className="ml-4 space-y-4">
                <div>
                  <h5 className="font-medium text-gray-800">Necessary / Essential Cookies</h5>
                  <p><span className="font-medium">Type:</span> Session Cookies</p>
                  <p><span className="font-medium">Administered by:</span> Us</p>
                  <p><span className="font-medium">Purpose:</span> These Cookies are essential to provide You with services available through the
                ...
                <div>
                  <h5 className="font-medium text-gray-800">Cookies Policy / Notice Acceptance Cookies</h5>
                ...
                <div>
                  <h5 className="font-medium text-gray-800">Functionality Cookies</h5>
                  <p><span className="font-medium">Type:</span> Persistent Cookies</p>
                  <p><span className="font-medium">Administered by:</span> Us</p>
                  <p><span className="font-medium">Purpose:</span> These Cookies allow us to remember choices You make when You use the Website
                  such as remembering your login details or language preference. The purpose of these
                  Cookies is to provide You with a more personal experience and to avoid You having to re-
                  enter your preferences every time You use the Website.</p>
                </div>
              </div>
            ...
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Use of Your Personal Data</h4>
              <p className="mb-4 leading-relaxed">
              ...
              <ol className="list-decimal ml-6 space-y-3">
                <li><span className="font-medium">With Service Providers:</span> We may share Your personal information with Service Providers to
                  monitor and analyze the use of our Service, to contact You.</li>
                <li><span className="font-medium">For business transfers:</span> We may share or transfer Your personal information in connection
                ...
                <li><span className="font-medium">With Affiliates:</span> We may share Your information with Our affiliates, in which case we will
                ...
                <li><span className="font-medium">With business partners:</span> We may share Your information with Our business partners to
                  offer You certain products, services or promotions.</li>
                <li><span className="font-medium">With other users:</span> when You share personal information or otherwise interact in the public
                  areas with other users, such information may be viewed by all users and may be publicly
                  distributed outside.</li>
                <li><span className="font-medium">With Your consent:</span> We may disclose Your personal information for any other purpose with
                  Your consent.</li>
              </ol>
            </div>
            ...
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Retention of Your Personal Data</h4>
              <p className="mb-4 leading-relaxed">
            ...
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Transfer of Your Personal Data</h4>
              <p className="mb-4 leading-relaxed">
            ...
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Disclosure of Your Personal Data</h4>
              
              <div className="mb-4">
                <h5 className="text-lg font-medium text-gray-800 mb-2">Business Transactions</h5>
                <p className="leading-relaxed">
              ...
              <div className="mb-4">
                <h5 className="text-lg font-medium text-gray-800 mb-2">Law enforcement</h5>
                <p className="leading-relaxed">
              ...
              <div>
                <h5 className="text-lg font-medium text-gray-800 mb-2">Other legal requirements</h5>
            ...
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Security of Your Personal Data</h4>
              <p className="leading-relaxed">
            ...
            {/* Children's Privacy */}
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Children&apos;s Privacy</h4>
              <p className="mb-4 leading-relaxed">
            ...
            <div className="mb-6">
              <h4 className="text-xl font-medium text-gray-800 mb-3">Links to Other Websites</h4>
              <p className="mb-4 leading-relaxed">
            ...
            <div>
              <h4 className="text-xl font-medium text-gray-800 mb-3">Changes to this Privacy Policy</h4>
              <p className="mb-4 leading-relaxed">
