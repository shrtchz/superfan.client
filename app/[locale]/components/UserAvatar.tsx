			...
			<DropdownMenu>
				<DropdownMenuTrigger asChild>
					<button className="flex items-center cursor-pointer text-black dark:text-white gap-0 rounded-md p1 hoverbg-gray-100 transition- mx-0 px-0">
						<div className="text-xl h-14 w-14 translate-x-2 flex items-center justify- cursor-pointer border-[#2f3336] dark:text-gray-500 text-gray-300 ">
							<UserCircleIcon />
						</div>
					</button>
				</DropdownMenuTrigger>
										...
										<div className="py4">
											<div className="space-y-3">
												...
												<button
													...
													className={`w-full flex items-center justify-between rounded-md px-3  transition-colors dark:text-white text-black ${
														selectedPlan === "1year"
															? "bg-primary/20 border border-gray-300 dark:border-gray-500 border-primary/30"
															: "hover:bg-gray-500/30"
													}`}
												>
													<div className="text-sm items-center text-left h-10 flex gap-2">
					...
					<div className="px-2 pb-6">
						...
						<div className="border-t overflow-auto">
							...
							<div className="grid text-sm grid-cols-10 font-semibold">
								...
								<div className="px-2 py-4 text-center col-span-2 border-gray-300 dark:border-gray-500 dark:border-gray-600">
									Test Date
								</div>
								<div className="px-2 py-4 text-center col-span-2 border-gray-300 dark:border-gray-500 dark:border-gray-600">
									Questions Completed
							...
							<>
								...
								<div className="space-y-4">
									...
									<button
										...
										className="w-full p-4 border border-gray-300 dark:border-gray-500 rounded-lg cursor-pointer dark:hover:text-black hover:bg-gray-50 transition-colors text-left"
									>
										<div className="flex justify-between items-center">
											<div>
											...
											<div className="w-4 h-4 rounded-full border-2 border-gray-300 dark:border-gray-500 flex items-center justify-center">
				...
				<DialogContent className="sm:max-w-md p-0 gap-0 overflow-hidden border-white/20">
					...
					<div className="px-6 pb-6 space-y-4">
						...
						<div className="space-y-2">
							...
							{showLockPanel && (
								<div className="absolute z-30  w-[90%] border rounded-md bg-white shadow-md mt1 px3 text-sm">
									<p className="px-3">
