...
const UserAvatar = () => {
  ...
  return (
    <div className="h-full w-full flex items-center">
      ...
      <DropdownMenu >
        <DropdownMenuTrigger asChild>
          <button className="flex items-center cursor-pointer text-black dark:text-white gap-0 rounded-md p1 hoverbg-gray-100 transition- mx-0 px-0">
            <div className="text-xl h-14 w-14 translate-x-2 flex items-center justify- cursor-pointer border-[#2f3336] text-gray-300 ">
        ...
        >
          ...
          <div className="p-4">
            <button
              className="w-full h-10 mb-3 rounded-full flex items-center justify-center text-sm font-medium border dark:hover:bg-white hover:bg-black hover:text-white dark:hover:text-black border-gray-300"
            ...
            <div className="mb-4">
              ...
              <DropdownMenuSub>
                ...
                <DropdownMenuPortal>
                  <DropdownMenuSubContent className="w-40 border-gray-300">
                    <div className="py4">
                      <div className="space-y-3">
                        ...
                        <button
                          ...
                          className={`w-full flex items-center justify-between rounded-md px-3  transition-colors dark:text-white text-black ${selectedPlan === "1month"
                        ...
                        <button
                          ...
                          className={`w-full flex items-center justify-between rounded-md px-3  transition-colors dark:text-white text-black ${selectedPlan === "1year"
                              ? "bg-primary/20 border border-gray-300 border-primary/30"
                              : "hover:bg-gray-500/30"
                            }`}
                        >
                          <div className="text-sm items-center text-left h-10 flex gap-2">
            ...
            <div>
              ...
              <DropdownMenuSub>
                ...
                <DropdownMenuPortal>
                  <DropdownMenuSubContent className="w-20 border-gray-300">
                    <div className="p2 w-full">
                      <div className="w-full items-start flex flex-col gap-2 ">
                        <button
                          ...
                          className={`flex-1 py-1 px-2 text-sm w-full text-left dark:text-white text-black ${selectedAccountType === "cash"
                        ...
                        <button
                          ...
                          className={`flex-1 py-1 px-2 text-sm w-full text-left dark:text-white text-black ${selectedAccountType === "points"
      ...
      >
        ...
        >
          <DialogHeader className="relative p-4 pb-4 flex flex-row justifybetween h-max items-center">
            ...
            <button className="h-14 w-14 rounded-full flex items-center justify-center border border-gray-300 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            <div className="absolute top-4 right-4">
              <button
                className="h-8 w-8 rounded-full flex items-center justify-center border-gray-300 hover:bg-gray-100 border"
            ...
            <div className="grid grid-cols-2 gap-6 ">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="name" className="w-full border-gray-300" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Input id="email" className="w-full border-gray-300" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="username" className="w-full border-gray-300" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="phone" className="w-full border-gray-300" />
                </div>
              </div>
            </div>
      ...
      {/* Scoreboard Dialog */}
      <Dialog
        open={scoreboardDialogOpen}
        onOpenChange={setScoreboardDialogOpen}
      >
        <DialogContent
          showCloseButton={false}
          ...
          <div className="px-2 pb-6">
            ...
            <div className="border-t overflow-auto">
              ...
              <div className="grid text-sm grid-cols-10 font-semibold">
                <div className="px-2 py-4 text-center col-span-1 border-r border-gray-400 dark:border-gray-500">
                  Test Code
                </div>
                <div className="px-2 py-4 text-center col-span-2 border-gray-300 dark:border-gray-600">
                  Test Date
                </div>
                <div className="px-2 py-4 text-center col-span-2 border-gray-300 dark:border-gray-600">
                  Questions Completed
                ...
                <div className="px-2 py-4 text-center flex flex-row gap-2 h-max justify-center items-center col-span-3 relative">
                  ...
                  <div className="relative inlineblock">
                    ...
                    >
                      Reward
                      <ChevronDown
                        className={`h-4 w-4 mt-1 transition-transform ${isDropdownOpen ? "rotate-180" : ""
                          }`}
                      />
                    </button>
                      ...
                      <div className="absolute top-full left-0 mt1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-10 min-w-[120px]">
                        {rewardOptions.map((option) => (
                          <button
                            ...
                            className={`w-full border-b text-left px3 py2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 first:rounded-t-md last:rounded-b-md ${rewardFilter === option.value
              ...
              <div>
                {filteredData.map((entry, index) => (
                  ...
                  >
                    ...
                    <div className="p-4 col-span-2 px-2 text-center border-gray-200 dark:border-gray-700">
                      {entry.testDate}
                    </div>
              ...
              {filteredData.length > 0 && (
                <div className="grid grid-cols-10 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                  ...
                  <div className="p-4 col-span-3 text-center font-medium">
                    <div className="flex flex-col gap-1">
                      {totals.totalCash > 0 && (
                        <span className="text-balack dark:text-white">
                          NGN{totals.totalCash}
                        </span>
                      )}
        ...
        >
          ...
          <div className="px-6 pb-6 space-y-6 mt-1">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600">
                Funds typically arrive in 1-2 hours.
              </p>
            </div>
            ...
            {!selectedBankAccount ? (
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Withdraw or send money to your bank account.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <button
                    onClick={() =>
                      handleBankAccountSelect("Omolade Yola, 0123456789 - UBA")
                    }
              ...
              <>
                ...
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">
                    Funds typically arrive in under an hour, but some can take
                    up to a day to reflect the credit. We&apos;ll be in touch if
