  ...
  return (
    <footer className="mb2 w-full border-t  border-b h-[31px] flex items-center py4">
        ...
        <div className="flex justify-between items-center w-full ">
          {/* Left side - Copyright */}
          <div className="text-sm  flex gap-1 h-max items-center dark:text-white text-gray-900 whitespace-nowrap ">
            © {currentYear} 
          ...
          {/* <div className="flex items-center space-x-3">
             ...
             <Link 
              ...
              className= dark:text-white"text-gray-900 hover:text-black transition-colors"
            >
           <div className="">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 ">
            <Link 
              href="/about" 
              className="font-medium dark:text-white text-gray-900 transition-colors whitespace-nowrap"
            >
              About
            </Link>
            <Link 
