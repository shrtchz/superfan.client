...
import { ChevronDown, ArrowLeft, X, CircleUserRound, Check } from "lucide-react"
...
export default function AuthNavbar() {
  ...
  return (
    <>
      <nav className="w-full text-inherit border-b border-b-[#2f3336] px-2 gap-xl:px-4 py-3 flex items-center justify-between">
        {/* LEFT SECTION - Question Type Selector */}
        <div className="flex items-center gap-3 flex-1 relative">
          <button
            onClick={() => setIsTestMenuOpen(!isTestMenuOpen)}
            className="flex items-center gap-3 dark:text-white text-black border border-gray rounded-md px-2 max:w-[120px] h-8 cursor-pointer"
          >
            <h1 className="text-sm">Start a Test</h1>
          </button>
            ...
            <div className="absolute top-10 left-0 h-[400px] overflow-auto z-50">
              ...
              <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden  w-80">
                ...
                <button
                  ...
                  className="w-full flex items-center px-6 border-t h-10 justify-center dark:text-white text-black hover:bg-muted/50 disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                >
                  Apply Selection
                </button>
              </div>
        ...
        {/* CENTER SECTION */}
        <div className="w-md xl:w-lg max-w-2xl overflow-hidden">
          <div className="h-8 flex flex-row ">
            <div className="data-[size=default]:h-8 !bg-inherit border-[#2f3336] text-black dark:text-white xl:px-2 px-1 xl:gap-1 gap-0 xl:w-36 text-xs xl:text-sm border rounded-md h-8 flex items-center justifycenter">
              Test Language - {language ? getLabel(languages, language) : ""}
            </div>
        ...
        {/* RIGHT SECTION */}
        <div className="flex items-center gap-0.5 xl:gap-2 flex-1 justify-end">
          <div className="flex items-center gap-1 xl:gap-4">
            {/* Questions Count Display */}
            <div className="flex items-center text-black dark:text-white w-max h-8 px-3 gap-2">
              <p>Questions Count</p>
            ...
            <DropdownMenuContent className="w-80 p-0 mr-4 dark:bg-black bgwhite" align="end">
              ...
              <div className="p-4">
                ...
                <div>
                  ...
                  <DropdownMenuSub>
                    <DropdownMenuSubTrigger className="w-max flex items-center p-2 cursor-pointer data-[state=open]:[&>svg]:rotate-90 [&>svg]:transition-transform [&>svg]:duration-200">
                      <div className="flex items-center dark:text-white gap-2">
                        <AwardIcon />
      ...
      <Dialog open={manageAccountDialogOpen} onOpenChange={setManageAccountDialogOpen}>
        <DialogContent showCloseButton={false} className="sm:max-w-xl p-0 gap-0 overflow-hidden">
          <DialogHeader className="relative p-4 pb-4 flex flex-row justify-between h-max items-center">
      ...
      <Dialog open={scoreboardDialogOpen} onOpenChange={setScoreboardDialogOpen}>
           <DialogContent showCloseButton={false} className="sm:max-w-5xl p-0 gap-0 h-[400px] overflow-auto">
             ...
             <div className="px-2 pb-6">
               ...
               <div className="border rounded-lg overflow-auto">
                 ...
                 <div className="grid text-sm grid-cols-10 font-semibold">
                   ...
                   <div className="px-2 py-4 text-center col-span-3 relative">
                         ...
                         <div className="absolute top-full left-0 mt-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-10 min-w-[120px]">
                           {rewardOptions.map((option) => (
                             <button
                               ...
                               className={`w-full border-b text-left px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 first:rounded-t-md last:rounded-b-md ${
