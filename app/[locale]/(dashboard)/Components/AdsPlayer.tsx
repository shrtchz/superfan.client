...
import PadIcon from "@/public/icons/PadIcon";
		...
		<Card className=" p-0 w-full rounded-2xl p-0 shadow-lg overflowhidden  border dark:border-white/20">
			<CardContent className="p-0">
				...
				<div className="flex itemscenter gap- justify-between px-2 py-2 text-xs text-gray-600 dark:text-white">
					<div className="flex itemscenter gap- font-semibold">
						<div className="h-16 w-16 ">
						<PadIcon/>
						</div>
						<div className="-translate-x-3">
							<p className="text-xs xl:text-base">Superfan Network</p>
							<p className="text-sm">Livestream</p>
						</div>
					</div>
					<div className="flex gap1 text-xs h-max itemscenter">
						...
						<DropdownMenu>
							<DropdownMenuTrigger asChild>
								<Button
									variant="ghost"
									className="h-max w-1 p-0 px-0 py-0 dark:text-white text-gray-600"
								>
				...
				<div className="xl:px-4 mt-2 rounded-2xl xl:py-2  dark:text-white text-gray-700 dark:bg-black bg-white">
					<div className="flex items-center justify-between gap-3">
						<div className="">
							<p className="flex1 font-bold">Showing now:</p>
							<p>Diabolic money Ep: 1</p>
						</div>
						<Button className="whitespace-nowrap  w-28 dark:bg-inherit dark:text-white dark:border border-gray-500 dark:hover:bg-background dark:hover:text-white rounded-full">
							Share
						</Button>
					</div>
				</div>
