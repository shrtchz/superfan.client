...
export default function PodcastDialog() {
  ...
  if (isPipMode) {
    return (
      <div className="fixed bottom-4 right-4 w-80 bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
        {/* PIP Header */}
  ...
  return (
    <Dialog open={isPodcastOpen} onOpenChange={closePodcast}>
      <DialogContent className="max-w-2xl p-0 gap-0 bg-white dark:bg-gray-900 rounded-lg overflowhidden">
        {/* Header */}
        <div className="w-full flex items-center justify-ccenter p-6 border-gray-200 dark:border-gray-700">
          ...
          />
            ...
            <div className="border  rounded-md flex h-max items-center gap-2 px-2 mt-4 ">
                <FaYoutube fill="red"/>
                Youtube
            </div>
          </div>
